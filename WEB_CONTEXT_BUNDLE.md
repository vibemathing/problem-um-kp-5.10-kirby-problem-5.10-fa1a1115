...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-5.10-kirby-problem-5.10-fa1a1115-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-5.10"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-5.10-kirby-problem-5.10-fa1a1115-v1",
      "problem_contract_sha256": "26766bcf9e3308c6ce622434bef9e3d8a1536629c7527ecc15f882a664c7c85d",
      "problem_id": "problem:um-kp-5.10-kirby-problem-5.10-fa1a1115",
      "route_id": "route:um-kp-5.10-kirby-problem-5.10-fa1a1115-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-5.10-kirby-problem-5.10-fa1a1115-source-fidelity-01",
      "graph_id": "graph:um-kp-5.10-kirby-problem-5.10-fa1a1115-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-5.10-kirby-problem-5.10-fa1a1115-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-5.10-kirby-problem-5.10-fa1a1115-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "The Andrews--Curtis Conjecture [AC65] for the trivial group: a presentation of the trivial group can be changed to the trivial presentation by Andrews--Curtis moves."
          },
          "statement_sha256": "dfb06c5f6df7c2445e0928aedb0e34a40950ede2b74e3f7504b81ce7a05ff51e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-5.10-kirby-problem-5.10-fa1a1115-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-5.10-kirby-problem-5.10-fa1a1115-root",
      "route_id": "route:um-kp-5.10-kirby-problem-5.10-fa1a1115-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-5.10-89fca0822499",
        "url": "https://www.unsolvedmath.com/problems/KP-5.10"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
